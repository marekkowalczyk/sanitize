...
- Characters that don't NFD-decompose are special-cased in a `specialCases` table (185 entries) covering Western/Central European (ł, ß, đ, ø, æ, œ, ħ, ı), Icelandic (þ, ð), Sami (ŋ, ŧ), Dutch (ĳ), Catalan (ŀ), African languages (ə, ɛ, ɔ, ɓ, ɗ, ɖ, ƙ, ƒ, ɲ, ʃ, ʒ, etc.), Croatian digraphs (ǆ, ǉ, ǌ), typographic ligatures (ﬀ, ﬁ, ﬂ, ﬃ, ﬄ), Roman numerals (Ⅰ–Ⅿ), super/subscript digits (²₂), vulgar fractions (½¼¾), letterlike symbols (№™℃µ), currency symbols (€£¥₿), and common signs (©®§°×±). Sources: Unicode CLDR Latin-ASCII, AnyAscii, Unidecode
