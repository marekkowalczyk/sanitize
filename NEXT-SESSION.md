...
- **Pre-scan collision detection** — highest priority safety feature before `-r` is used on real trees. Build old->new mapping, detect duplicates, abort before any renames. See BACKLOG.md.
